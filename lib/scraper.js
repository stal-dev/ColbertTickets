...
// Chromium binary hosted on GitHub (from @sparticuz/chromium releases)
const CHROMIUM_URL = 'https://github.com/Sparticuz/chromium/releases/download/v141.0.0/chromium-v141.0.0-pack.tar';
...
async function getBrowser() {
  ...
  // chromium-min downloads from the provided URL automatically
